{
  ...
  spec: {
      ...
      spec: {
        ...
        containers: {
          ...
          securityContext: {
            ...
            '#withPrivileged':: d.fn(help="\"Run container in privileged mode. This can only be set to explicitly to 'false'\"", args=[d.arg(name='privileged', type=d.T.boolean)]),
        ...
        volumes: {
          ...
          '#withEmptyDir':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-volumes-emptydir"', args=[d.arg(name='emptyDir', type=d.T.object)]),
          withEmptyDir(emptyDir): { emptyDir: emptyDir },
          '#withEmptyDirMixin':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-volumes-emptydir"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='emptyDir', type=d.T.object)]),
          withEmptyDirMixin(emptyDir): { emptyDir+: emptyDir },
          '#withHostPath':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-volumes-hostpath"', args=[d.arg(name='hostPath', type=d.T.object)]),
          withHostPath(hostPath): { hostPath: hostPath },
          '#withHostPathMixin':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-volumes-hostpath"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostPath', type=d.T.object)]),
          withHostPathMixin(hostPath): { hostPath+: hostPath },
        ...
        '#withEnableServiceLinks':: d.fn(help="\"EnableServiceLinks indicates whether information aboutservices should be injected into pod's environment variables, matching the syntax of Docker links. Optional: Knative defaults this to false.\"", args=[d.arg(name='enableServiceLinks', type=d.T.boolean)]),
        ...
        '#withHostIPC':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-hostipc"', args=[d.arg(name='hostIPC', type=d.T.boolean)]),
        withHostIPC(hostIPC): { spec+: { template+: { spec+: { hostIPC: hostIPC } } } },
        '#withHostNetwork':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-hostnetwork"', args=[d.arg(name='hostNetwork', type=d.T.boolean)]),
        withHostNetwork(hostNetwork): { spec+: { template+: { spec+: { hostNetwork: hostNetwork } } } },
        '#withHostPID':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-hostpid"', args=[d.arg(name='hostPID', type=d.T.boolean)]),
        withHostPID(hostPID): { spec+: { template+: { spec+: { hostPID: hostPID } } } },
        '#withIdleTimeoutSeconds':: d.fn(help="\"IdleTimeoutSeconds is the maximum duration in seconds a request will be allowed\\nto stay open while not receiving any bytes from the user's application. If\\nunspecified, a system default will be provided.\"", args=[d.arg(name='idleTimeoutSeconds', type=d.T.integer)]),
        ...
        '#withInitContainers':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-init-containers"', args=[d.arg(name='initContainers', type=d.T.array)]),
        ...
        '#withInitContainersMixin':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-init-containers"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
        ...
        '#withResponseStartTimeoutSeconds':: d.fn(help='"ResponseStartTimeoutSeconds is the maximum duration in seconds that the request\\nrouting layer will wait for a request delivered to a container to begin\\nsending any network traffic."', args=[d.arg(name='responseStartTimeoutSeconds', type=d.T.integer)]),
        ...
        '#withShareProcessNamespace':: d.fn(help='"This is accessible behind a feature flag - kubernetes.podspec-shareprocessnamespace"', args=[d.arg(name='shareProcessNamespace', type=d.T.boolean)]),
        withShareProcessNamespace(shareProcessNamespace): { spec+: { template+: { spec+: { shareProcessNamespace: shareProcessNamespace } } } },
        '#withTimeoutSeconds':: d.fn(help='"TimeoutSeconds is the maximum duration in seconds that the request instance\\nis allowed to respond to a request. If unspecified, a system default will\\nbe provided."', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    '#traffic':: d.obj(help='"Traffic specifies how to distribute traffic over a collection of\\nrevisions and configurations."'),
    traffic: {
      '#withConfigurationName':: d.fn(help="\"ConfigurationName of a configuration to whose latest revision we will send\\nthis portion of traffic. When the \\\"status.latestReadyRevisionName\\\" of the\\nreferenced configuration changes, we will automatically migrate traffic\\nfrom the prior \\\"latest ready\\\" revision to the new one.  This field is never\\nset in Route's status, only its spec.  This is mutually exclusive with\\nRevisionName.\"", args=[d.arg(name='configurationName', type=d.T.string)]),
      withConfigurationName(configurationName): { configurationName: configurationName },
      '#withLatestRevision':: d.fn(help='"LatestRevision may be optionally provided to indicate that the latest\\nready Revision of the Configuration should be used for this traffic\\ntarget.  When provided LatestRevision must be true if RevisionName is\\nempty; it must be false when RevisionName is non-empty."', args=[d.arg(name='latestRevision', type=d.T.boolean)]),
      withLatestRevision(latestRevision): { latestRevision: latestRevision },
      '#withPercent':: d.fn(help='"Percent indicates that percentage based routing should be used and\\nthe value indicates the percent of traffic that is be routed to this\\nRevision or Configuration. `0` (zero) mean no traffic, `100` means all\\ntraffic.\\nWhen percentage based routing is being used the follow rules apply:\\n- the sum of all percent values must equal 100\\n- when not specified, the implied value for `percent` is zero for\\n  that particular Revision or Configuration"', args=[d.arg(name='percent', type=d.T.integer)]),
      withPercent(percent): { percent: percent },
      '#withRevisionName':: d.fn(help='"RevisionName of a specific revision to which to send this portion of\\ntraffic.  This is mutually exclusive with ConfigurationName."', args=[d.arg(name='revisionName', type=d.T.string)]),
      withRevisionName(revisionName): { revisionName: revisionName },
      '#withTag':: d.fn(help='"Tag is optionally used to expose a dedicated url for referencing\\nthis target exclusively."', args=[d.arg(name='tag', type=d.T.string)]),
      withTag(tag): { tag: tag },
      '#withUrl':: d.fn(help='"URL displays the URL for accessing named traffic targets. URL is displayed in\\nstatus, and is disallowed on spec. URL must contain a scheme (e.g. http://) and\\na hostname, but may not contain anything else (e.g. basic auth, url path, etc.)"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { url: url },
    },
    '#withTraffic':: d.fn(help='"Traffic specifies how to distribute traffic over a collection of\\nrevisions and configurations."', args=[d.arg(name='traffic', type=d.T.array)]),
    withTraffic(traffic): { spec+: { traffic: if std.isArray(v=traffic) then traffic else [traffic] } },
    '#withTrafficMixin':: d.fn(help='"Traffic specifies how to distribute traffic over a collection of\\nrevisions and configurations."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='traffic', type=d.T.array)]),
