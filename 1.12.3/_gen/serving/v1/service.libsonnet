{
  ...
  '#':: d.pkg(name='service', url='', help="\"Service acts as a top-level container that manages a Route and Configuration which implement a network service. Service exists to provide a singular abstraction which can be access controlled, reasoned about, and which encapsulates software lifecycle decisions such as rollout policy and team resource ownership. Service acts only as an orchestrator of the underlying Routes and Configurations (much as a kubernetes Deployment orchestrates ReplicaSets), and its usage is optional but recommended. \\n The Service's controller will track the statuses of its owned Configuration and Route, reflecting their statuses and conditions as its own. \\n See also: https://github.com/knative/serving/blob/main/docs/spec/overview.md#service\""),
  ...
  spec: {
    ...
    '#traffic':: d.obj(help='"Traffic specifies how to distribute traffic over a collection of revisions and configurations."'),
    traffic: {
      '#withConfigurationName':: d.fn(help="\"ConfigurationName of a configuration to whose latest revision we will send this portion of traffic. When the \\\"status.latestReadyRevisionName\\\" of the referenced configuration changes, we will automatically migrate traffic from the prior \\\"latest ready\\\" revision to the new one.  This field is never set in Route's status, only its spec.  This is mutually exclusive with RevisionName.\"", args=[d.arg(name='configurationName', type=d.T.string)]),
      ...
      '#withPercent':: d.fn(help='"Percent indicates that percentage based routing should be used and the value indicates the percent of traffic that is be routed to this Revision or Configuration. `0` (zero) mean no traffic, `100` means all traffic. When percentage based routing is being used the follow rules apply: - the sum of all percent values must equal 100 - when not specified, the implied value for `percent` is zero for that particular Revision or Configuration"', args=[d.arg(name='percent', type=d.T.integer)]),
      withPercent(percent): { percent: percent },
      '#withRevisionName':: d.fn(help='"RevisionName of a specific revision to which to send this portion of traffic.  This is mutually exclusive with ConfigurationName."', args=[d.arg(name='revisionName', type=d.T.string)]),
      ...
      withTag(tag): { tag: tag },
      '#withUrl':: d.fn(help='"URL displays the URL for accessing named traffic targets. URL is displayed in status, and is disallowed on spec. URL must contain a scheme (e.g. http://) and a hostname, but may not contain anything else (e.g. basic auth, url path, etc.)"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { url: url },
    },
    '#withTraffic':: d.fn(help='"Traffic specifies how to distribute traffic over a collection of revisions and configurations."', args=[d.arg(name='traffic', type=d.T.array)]),
    withTraffic(traffic): { spec+: { traffic: if std.isArray(v=traffic) then traffic else [traffic] } },
    '#withTrafficMixin':: d.fn(help='"Traffic specifies how to distribute traffic over a collection of revisions and configurations."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='traffic', type=d.T.array)]),
